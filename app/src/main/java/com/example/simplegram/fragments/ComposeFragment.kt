...
import com.example.simplegram.MainActivity
...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated( view: View, savedInstanceState: Bundle? ) {
        ...
        // setup onClick listeners and handle logic
        ...
        view.findViewById<Button>( R.id.bSave ).setOnClickListener {
            ...
            if ( photoFile != null ) {
                ...
                Log.e(MainActivity.TAG, "Save failed: photo is null" )
                Toast.makeText( requireContext(), "Save failed: photo is null", Toast.LENGTH_SHORT ).show()
            }
        }

        view.findViewById<Button>( R.id.bCamera ).setOnClickListener {
    ...
    fun submitPost( description: String, user: ParseUser, file: File ) {
        ...
        post.saveInBackground { exception ->
            if ( exception != null ) {
                ...
                Toast.makeText( requireContext(), "Post failed to be created", Toast.LENGTH_SHORT ).show()
            } else {
                Log.i( TAG, "Post successful" )

                // reset view in preparation for another post
                etDescription = requireView().findViewById( R.id.etDescription )
                etDescription.setText( "" )

                ivPhoto = requireView().findViewById( R.id.ivPhoto )
